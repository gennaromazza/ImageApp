...
const StatusChangeModal: React.FC<StatusChangeModalProps> = ({
  ...
  const handleStatusChange = async () => {
    ...
    try {
      ...
      // Dopo il salvataggio, chiedi se inviare il messaggio WhatsApp
  ...
  const handleWhatsAppConfirm = () => {
    // Costruisce il messaggio di default
    const statusName = getStatusName(selectedStatusId) || 'stato aggiornato';
    const message = `Ciao ${customerName}, In merito al tuo ordine, c'è un progresso nello stato della lavorazione adesso è nello stato di ${statusName}.`;
  ...
  const handleWhatsAppCancel = () => {
    // Non invia il messaggio: chiude la modale
    onClose();
  };

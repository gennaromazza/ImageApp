...
const CalendarCallbackPage: React.FC = () => {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      try {
        console.log("🔄 Avvio gestione callback Google Calendar...");
        ...
        console.log("📩 Ricevuto codice di autorizzazione:", code);
        ...
        {error ? (
          ...
          <>
            ...
            <p className="text-gray-400">
              {loading ? 'Stiamo connettendo il tuo Google Calendar...' : 'Reindirizzamento completato!'}
            </p>
          </>
        )}
      </motion.div>

        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-gray-700 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-white mb-4">
              Personalizzazione Pagina Prenotazioni
            </h3>
            <p className="text-gray-400 mb-4">
              Personalizza l'URL della tua pagina di prenotazioni.
            </p>
            <div className="flex items-center gap-4">
              <input
                ...
                className="flex-1 p-3 bg-gray-600 border border-gray-500 rounded text-white"
                placeholder="URL personalizzato (es: /booking/your-business)"
              />
            </div>
          </div>
